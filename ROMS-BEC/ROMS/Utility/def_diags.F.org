...
!
!svn $Id: def_diags.F 658 2013-04-18 22:17:05Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &              0.5_r8*REAL(nDIA(ng),r8)*dt(ng)
      END IF
!
  10  FORMAT (6x,'DEF_DIAGS - creating diagnostics file, Grid ',i2.2,   &
     &        ': ',a)
  20  FORMAT (6x,'DEF_DIAGS - inquiring diagnostics file, Grid ',i2.2,  &
     &        ': ',a)
