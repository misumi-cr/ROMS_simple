...
/*
** Activate switch for processing 3d influx data.
*/
...
/*
** Activate switch for processing 3d ligand data.
*/
...
/*
** Activate switch for processing data sea ice.
*/
...
/*
** Activate switch for processing dust data
*/
...
/*
** Activate switch for processing tide data
*/

#if (defined LMD_TMIX  && defined SOLVE3D)
# define TMIX_FILE
#endif
...
#if !defined BEC && defined CISO
# undef CISO
#endif

#if !defined CISO && defined ANA_CISO
# undef ANA_CISO
#endif
/*
...
# endif
#endif
#if !defined BIO_FENNEL && !defined BEC && defined DIAGNOSTICS_BIO
