...
!
!! svn $Id: ana_hmixcoef.h 658 2013-04-18 22:17:05Z arango $
!!================================================= Hernan G. Arango ===
...
# endif
# ifdef UV_VIS4
      cff=visc4(ng)/(grdmax(ng)**1.5)         !DCC2014.12.24
      DO j=JstrT,JendT
        DO i=IstrT,IendT
          visc4_r(i,j)=cff*grdscl(i,j)**1.5   !DCC2014.12.24
        END DO
      END DO
      cff=0.25_r8*cff
      DO j=JstrP,JendT
        DO i=IstrP,IendT
          visc4_p(i,j)=cff*(grdscl(i,j  )**1.5+grdscl(i-1,j  )**1.5+        &     !DCC2014.12.24
     &                      grdscl(i,j-1)**1.5+grdscl(i-1,j-1)**1.5)              !DCC2014.12.24
        END DO
      END DO
# endif
#endif
...
# ifdef TS_DIF4
      DO itrc=1,NT(ng)
        cff=tnu4(itrc,ng)/(grdmax(ng)**1.5)        !DCC2014.12.24
        DO j=JstrT,JendT
          DO i=IstrT,IendT
            diff4(i,j,itrc)=cff*grdscl(i,j)**1.5   !DCC2014.12.24
          END DO
        END DO
      END DO
# endif
