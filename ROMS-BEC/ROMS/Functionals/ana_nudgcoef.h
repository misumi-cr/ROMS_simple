...
# ifdef TCLM_NUDGING
            IF (DOMAIN(ng)%SouthWest_Corner(tile)) THEN
              Tobc_out(itrc,ng,iwest)=CLIMA(ng)%Tnudgcof(0,1,1,itrc)
     ...
     &                                Tobc_out(itrc,ng,iwest)
            ...
            IF (DOMAIN(ng)%Western_Edge(tile)) THEN
              DO k=1,N(ng)
                DO j=JstrT,JendT
                  CLIMA(ng)%Tnudgcof(0,j,k,itrc)=0.0_r8
                END DO
              END DO
            END IF
# else
...
# ifdef TCLM_NUDGING
     ...
     &                 CLIMA(ng)%Tnudgcof(Lm(ng)+1,Mm(ng),1,itrc)
     ...
     &                                Tobc_out(itrc,ng,ieast)
            ...
            IF (DOMAIN(ng)%Eastern_Edge(tile)) THEN
              DO k=1,N(ng)
                DO j=JstrT,JendT
                  CLIMA(ng)%Tnudgcof(Lm(ng)+1,j,1,itrc)=0.0_r8
                END DO
              END DO
            END IF
# else
...
# ifdef TCLM_NUDGING
            IF (DOMAIN(ng)%SouthWest_Corner(tile)) THEN
              Tobc_out(itrc,ng,isouth)=CLIMA(ng)%Tnudgcof(1,0,1,itrc)
     ...
     &                                 Tobc_out(itrc,ng,isouth)
            ...
            IF (DOMAIN(ng)%Southern_Edge(tile)) THEN
              DO k=1,N(ng)
                DO i=IstrT,IendT
                  CLIMA(ng)%Tnudgcof(i,0,1,itrc)=0.0_r8
                END DO
              END DO
            END IF
# else
...
# ifdef TCLM_NUDGING
     ...
     &                 CLIMA(ng)%Tnudgcof(Lm(ng),Mm(ng)+1,1,itrc)
     ...
     &                                 Tobc_out(itrc,ng,inorth)
            ...
            IF (DOMAIN(ng)%Northern_Edge(tile)) THEN
              DO k=1,N(ng)
                DO i=IstrT,IendT
                  CLIMA(ng)%Tnudgcof(i,Mm(ng)+1,1,itrc)=0.0_r8
                END DO
              END DO
            END IF
# else
